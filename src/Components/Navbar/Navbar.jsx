            ...
            <div className="Nav__right">
              <dl className="Nav__item-wrapper">
                <dd className="Nav__item__top">
                  <center><img src={HearthPic} className="Nav__logo" /></center>
                </dd>
                <dd className="Nav__item">
                <img src={OverviewPic} className="Nav__logo" />
                  <Link className="Nav__link" to="/Overview"><h4>Overview</h4></Link>
                </dd>
                <dd className="Nav__item">
                <img src={ActivitiesPic} className="Nav__logo" />
                  <Link className="Nav__link" to="/Addactivities"><h4>Activities</h4></Link>
                </dd>
                <dd className="Nav__item">
                <img src={CommunityPic} className="Nav__logo" />
                  <Link className="Nav__link" to="/Community"><h4>Community</h4></Link>
                </dd>
                <dd className="Nav__item">
                <img src={ChallengePic} className="Nav__logo" />
                  <Link className="Nav__link" to="/Challenge"><h4>Challenge</h4></Link>
                </dd>
                <dd className="Nav__item">
                <img src={SettingPic} className="Nav__logo" />
                  <Link className="Nav__link" to="/Setting"><h4>Setting</h4></Link>
                </dd>
              </dl>
            </div>
          </div>
