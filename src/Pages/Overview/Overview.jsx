    ...
    <div className="OverviewArea">
      ...
      <div className="MiddleSection">
        <div className="LastestSection">
          ...
          <div className="LatestCards"><OverviewCard card = {lastestcard}/></div>
        </div>
        <div className="TodaySection">
          <p>Today Activities:</p>
          <div className="TodaysCards"><OverviewCard card = {todaycard}/></div>
        </div>
        <div className="StatusSection">
          <div className="StatusCard">
            <div className="StatusImg CalImg">
              {/*Card Image Here*/}
              <img src={CalPic} />{" "}
            </div>
            <div>
          ...
          <div className="StatusCard">
            <div className="StatusImg StepImg">
              {/*Card Image Here*/}
              <img src={StepPic} />{" "}
            </div>
            <div>
          ...
          <div className="StatusCard">
            <div className="StatusImg ActImg">
              {/*Card Image Here*/}
              <img src={ActPDayPic} />{" "}
            </div>
            <div>
          ...
          <div className="StatusCard">
            <div className="StatusImg WaterImg">
              {/*Card Image Here*/}
              <img src={WaterPic} />{" "}
            </div>
            <div>
        ...
        <div className="TrophySection">
          ...
          <div className="ChallengeBoard">
            <div className="ChallengeLeft">
              ...
              <div className="ChallengeWeekly">
                <div className="StatusImg-RunningPic">
                  {/*Card Image Here*/}
                  <img src={RunningPic} />
                </div>
                <div>
          ...
          <div className="TrophyBoard">
            ...
            <div className="TrophyCard">
              <div className="StatusImg RunGold">
                {/*Card Image Here*/}
                <img src={RunningGold} />{" "}
              </div>
              <div>
            ...
            <div className="TrophyCard">
              <div className="StatusImg RunSilver">
                {/*Card Image Here*/}
                <img src={RunningSilver} />{" "}
              </div>
              <div>
            ...
            <div className="TrophyCard">
              <div className="StatusImg RunBrass">
                {/*Card Image Here*/}
                <img src={RunningBrass} />{" "}
              </div>
              <div>
